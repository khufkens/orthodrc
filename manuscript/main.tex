...
%=================================================================
\documentclass[remote sensing,article,submit,moreauthors,pdftex,10pt,a4paper]{mdpi}
...
\Author{Koen Hufkens$^{1,2,*}$\href{https://orcid.org/0000-0002-5070-8109}{\orcidicon}, Thalès de Haulleville$^{3}$, Elizabeth Kearsley$^{1}$, Kim Jacobsen$^{2,3}$, Hans Beeckman$^{3}$, Piet Stoffelen$^{4}$, Filip Vandelook$^{4}$, Sofie Meeus$^{4}$, Michael Amara$^{5}$, Leen Van Hirtum$^{5}$, Jan Van den Bulcke$^{1}$, Hans Verbeeck$^{1}$, Lisa Wingate$^{2}$}
...
\abstract{Land Use and Land Cover change (LULCC) of African rainforest contribute
to global carbon emissions. Yet, most historical estimates of LULCC and
their carbon emissions rely on non-spatially explicity data in the
pre-satellite era (\textless{} 1972). Past studies have expanded this
pre-satellite time frame with declassified satellite surveillance data
or aerial surveys, but none cover the Congo Basin. Here, we use
historical aerial survey photos to map the extent and structure of LULCC
around Yangambi, central Congo Basin, in 1958. Our study leveraged
Structure-from-Motion to generate a large orthomosaic covering 828
km\textsuperscript{2}, counting 733 million pixels, at a sub meter
resolution and geo-referenced to \textasciitilde{}4.7 \(\pm\) 4.3 m.
Primary forest in the orthomosaic was classified with a Convoluted
Neural Network Deep Learning approach. We used these data to quantify
LULCC, landscape and canopy complexity and scale above ground biomass
between historical and contemporary condition. We show a shift from
historical highly structured industrial deforestation in 1958 (162
km\textsuperscript{2}), to contemporary smallholder farming clearing (88
km\textsuperscript{2}), increasing landscape fragmentation and forest
edges. Efforts to quantify canopy texture and their link to carbon
storage had limited to no success. Our analysis provides an insight in
key spatial and temporal patterns of deforestation and reforestation at
a multi-decadal scale and provide a historical context to land-cover and
land-use change spatial patterns for past and ongoing field research in
the area.}
...
\usepackage{wrapfig} \usepackage{graphics} \usepackage{setspace}

\doublespacing 

\usepackage{gensymb} \usepackage{booktabs}
...
\begin{figure}
\includegraphics[width=1\linewidth]{./figures/foto_maps} \caption{RGB visualizations of the first three principal components of scene wide FOTO texture analysis of historical and current (Geo-Eye) imagery. Current permanent sampling plots of mono-dominant, mixed, fallow and young (edge) forest plots are marked with open triangles, open circles, open squares and crosses, respectively.}\label{fig:unnamed-chunk-9}
\end{figure}
...
All analysis code is available as an R \citep{rcoreteam2019} project
(\url{https://github.com/khufkens/orthodrc}). The analysis relied
...
COBECORE project (BELSPO; grant BR/175/A3/COBECORE). KH acknowledges
funding from the European Union Marie Skłodowska-Curie Action (project
number 797668). I'm grateful for the support of Thales D'Haulleville
volunteering his time in scanning the images.}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{K.H. conceived and designed the study, analyzed the data, prepared
figures and tables, authored, reviewed and approved the final draft of
the manuscript. T.d.H. scanned all image data. E.K. and T.d.H. provided
plot based AGC estimates. T.D., K.J., E.K, H.B., P.S., F.V.,S.M., M.A.,
J.V.D.B., H.V and L.W. reviewed the final manuscript.}
